...
import { addToBasket, changeInBasket, removeFromBasket } from '@/features/basket/actions';
...
export function Actions({ goods }: ActionsProps) {
  ...
  const basketItem = useAppSelector(state => selectBasketItemById(state, { goodsId }));
