...
export const selectBasketAmount = createSelector(selectBasketItems, basketItems => {
  return basketItems
...
export const selectBasketQuantity = createSelector(selectBasketItems, basketItems => {
